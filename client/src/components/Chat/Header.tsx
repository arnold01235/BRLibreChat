...
function Header({
  ...
  return (
    <div className="absolute top-0 z-10 flex h-[52px] w-full items-center gap-2 border-b border-border-light bg-presentation p-2 font-semibold text-text-primary">
